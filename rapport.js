...
const resultat1 = `<h1 class="rapport">Merci d’avoir pris le temps de répondre aux différentes questions de ce guide !<br>
  ...
  l’adresse de votre commerce ou encore vos horaires d’ouverture. Sans site Internet, vous passez à côté d'une énorme opportunité d’informer et d’attirer ces clients.<br><br>
  Un site web (bien conçu !) permet alors de présenter vos produits, de partager des informations importantes et de répondre aux questions des clients potentiels, le tout dans un espace où vous avez un contrôle total sur l'image de votre marque.
  <br></p>`;
  ...
  Il serait bien dommage de ne pas profiter de cet impact pour mettre en avant votre commerce.<br><br>\
  Il est également important de savoir que la création de votre fiche peut se faire automatiquement et sans votre accord. En prenant en compte les informations disponibles sur Internet et \
  ...
  alors primordiale pour garder le contrôle de vos informations !<br></p>`;
...
<p class="rapport">Une newsletter est un e-mail envoyé afin de diffuser des informations relatives à votre activité. Cet outil s'adresse à une liste de destinataires ayant souscrit volontairement à l'envoi d'e-mails marketing et\
 est un puissant moyen de maintenir le contact avec eux, de partager des informations importantes et de promouvoir vos produits.\
...
<p class="rapport">75% des Suisses utiliseraient les médias sociaux au quotidien ! Imaginez tous les avantages que cela pourrait offrir à votre commerce.\
...
const ifCapacite = `<p class="rapport">L’âge de votre clientèle (et/ou de votre clientèle cible)\
 est le facteur principal définissant les outils numériques à adopter. De plus, selon le temps que\
...
//****************************			
const ifPasCapacite = `<p class="rapport"> Cependant, le temps et le budget que vous pouvez\
 mettre à disposition pour ces différents outils influencent directement votre capacité à tirer\
 pleinement profit de leurs avantages. Selon vos réponses, l’utilisation des médias sociaux pour votre\
 commerce n’est peut-être pas pertinente. S'il vous est possible de déléguer la gestion de ces outils ou de \
...
un réel avantage, mais ce guide ne peut malheureusement pas vous conseiller (ou non) la mise en place\
 d’un tel outil. En effet, plusieurs éléments importants doivent être pris en considération tels que : <br><br>\
...
retours « offerts » et de gros rabais. Une analyse plus poussée sur le marché actuel est nécessaire. <br>\
<br>\
...
créer des descriptions pertinentes, déployer toute une infrastructure informatique, gérer\
 en temps réel les stocks et sans parler de… la sécurité de votre plateforme ou encore des\
  modalités de paiement. La mise en place d’un commerce en ligne nécessite beaucoup de compétences,\
...
Vous l’aurez compris, mettre en place un site e-commerce nécessite beaucoup de réflexion, beaucoup\
 ...
 Cependant ! Si vos produits sont suffisamment uniques et ne sont pas intégrés dans les catalogues de vente des géants en ligne\
  à -50%, que la concurrence est faible et que vous avez le temps, les compétences et/ou les finances nécessaires pour vous lancer,\
...
<li class="popup">Votre nom de domaine est court et mémorable</li>
...
<li class="popup">Votre SEO est optimisé</li>
	...
	<li class="popup">Lien vers votre site internet</li>
	<li class="popup">Catégorie du commerce</li>
	</ul>`,

	"Facebook": `<h2 class="popup">La check-list de Facebook</h2>
	<p class="popup">Voici les éléments à connaître pour profiter des avantages de cet outil :</p>
	<ul>
